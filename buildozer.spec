...
requirements = python3,kivy==2.1.0,requests,android,pyjnius,liblzma,libuuid
...
# setup.py if you're using Poetry, but you need to set use_setup_py to true to build the app.
p4a.setup_py = false
